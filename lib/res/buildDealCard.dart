...
Widget buildDealCard({
  ...
  Color statusColor =
      status == "Active" ? Color(0xFF90EE90) : Color(0xFFFFDF00);
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                actionButton(
                  CommonImage("assets/images/editb.png", width: 22),
                  "Edit".tr,
                  onEdit,
                ),
                actionButton(
                ...
                actionButton(
                  CommonImage("assets/images/delete.png", width: 18),
                  "Delete".tr,
                  onDelete,
                  color: Colors.red,
                ),
...
void showReasonDialog(
  ...
  String title = "Why do you want to pause this deal?",
}) {
