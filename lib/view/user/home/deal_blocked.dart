...
class DealBlockedPage extends StatefulWidget {
  @override
  _DealBlockedPageState createState() => _DealBlockedPageState();
}

class _DealBlockedPageState extends State<DealBlockedPage> with TickerProviderStateMixin {
...
_fadeRow = Tween<double>(begin: 0, end: 1).animate(
  CurvedAnimation(parent: _dealController, curve: Interval(0.4, 0.6, curve: Curves.easeIn)),
);
