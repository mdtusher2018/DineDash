...
import 'package:dine_dash/view/user/deals/all_available_deals.dart';
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      navigateToPage(AllAvailableDeals());
                    },
                    child: commonText("See all",size: 14,fontWeight: FontWeight.w500,color: Color(0xff555555))),
                ],
              ),
              SizedBox(height: 8,),
              ListView.builder(
