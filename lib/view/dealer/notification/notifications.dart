    ...
    return Scaffold(
      ...
      ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          bool isRead = index >2 ; // Just an example: alternate between read and unread
          ...
          return ListTile(
            ...
            leading: Icon(
              ...
              size: 32,
              color:  AppColors.primaryColor, // Different color based on read/unread
            ),
            title: commonText(
            ...
            subtitle: Column(
              ...
              children: [
                ...
                commonText(
                  "16 minutes ago", // Placeholder for the actual time
                  isBold: true,
                  size: 12,
                  color:  Colors.black87, // Subtitle color change based on read/unread
                ),
              ],
            ),
            tileColor: isRead ? AppColors.white : Color(0xFFB7CDF5), // Background color for read/unread
          );
        },
      ),
    );
