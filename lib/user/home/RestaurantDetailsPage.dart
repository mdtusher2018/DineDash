              ...
              child: ListView(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Flexible(
                        child: commonText("The Rio Lounge", size: 18, fontWeight: FontWeight.w800),
                      ),
                      Row(
                        children: [
                          Image.asset("assets/images/medel.png"),
                          SizedBox(width: 4),
                          commonText("5.0", size: 14,fontWeight: FontWeight.w500), SizedBox(width: 4),
                  ...
                  Row(
                    children:  [
                      ...
                      Spacer(),
                      commonText("€€€€",color: Colors.green,isBold: true,size: 14),
                      Spacer(),
                    ],
                  ),
...
Divider(),
          ...
          buildDealCard(title: "Free cold drinks",subText: "Lorem ipsum dolor sit amet consectetur. Rhoncus molestie amet non pellentesque.", duration: "60 Days", location: "Gulshan 2."),
               ...
               Column(
                ...
                children: [
commonText("Ratings & Reviews",size: 16,isBold: true,color: AppColors.primaryColor),
          ...
          commonText("120 ratings | 70 reviews",color: Colors.blueGrey,isBold: true),
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              /// Book button
              commonButton("Book deal", color: AppColors.primaryColor,height: 40,onTap: (){
                showDealBottomSheet(
context,
                    title: "Free cold drinks",
  description: "Lorem ipsum dolor sit amet consectetur. Rhoncus molestie amet non pellentesque.",
        ...
        Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  shape: BoxShape.circle,
                  image: DecorationImage(image: NetworkImage("https://tse1.mm.bing.net/th/id/OIP.HNY2Wi4N2JYdkAAU9oLPVgHaLH?rs=1&pid=ImgDetMain&o=7&rm=3"),fit: BoxFit.cover)
                ),
                ),SizedBox(width: 8,),
          ...
          return Icon(
           Icons.star,
            ...
            size: 20,
              ...
              SizedBox(width: 4,),Flexible(child: commonText("1 month ago"))
            ],
          ),
          commonText("This is a comment",fontWeight: FontWeight.w500,size: 14),
            ],
          ),
                );
}
...
Widget restaurantInfoTab() {
  ...
  return Column(
    ...
    children: [
      ...
      Row(
        children: [
Image.asset("assets/images/location2.png",color: AppColors.primaryColor,),
          const SizedBox(width: 8),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              commonText("Location", isBold: true, color: AppColors.primaryColor, size: 16),
      ...
      Row(
        children: [
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              commonText("Contact", isBold: true,  color: AppColors.primaryColor, size: 16),
          ...
          Expanded(
            child: Column(
              children: [
                Row(
                  children: [
                    commonText("Opening hours",
                        isBold: true,  color: AppColors.primaryColor, size: 16),
                  ],
                ),
...
void showDealBottomSheet(BuildContext context,{
...
void showMenuBottomSheet(BuildContext context) {
  ...
  itemBuilder: (context, index) {
    return ListTile(
      minVerticalPadding: 8,minTileHeight: 0,
   
      contentPadding: EdgeInsets.all(0),
      title: commonText("OPERA VEGAN", size: 16, fontWeight: FontWeight.w500),
