  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          /// Content
          showMap ? _buildMapView() : SafeArea(child: Padding(
  ...
  Widget toggleButton({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Image.asset(icon,  color: isSelected ? Colors.white : AppColors.primaryColor),
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
                    Row(
                    children:  [
                      commonText("Rampura, Dhaka.", size: 18, fontWeight: FontWeight.bold,color: AppColors.gray),
        ...
        child: DropdownButtonHideUnderline(
          child: Container(
            ...
            child: DropdownButton<String>(
              ...
              items: ['Expense', 'Low to High', 'High to Low']
                  .map((String value) {
                return DropdownMenuItem<String>(
                  ...
                  child: Row(
                    children: [
                      ...
                      if (value == 'Expense') const SizedBox(width: 8),
                      commonText(value),
                    ],
                  ),
                );
